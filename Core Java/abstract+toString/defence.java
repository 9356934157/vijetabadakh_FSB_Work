...
abstract public class Defence {
	...
	public String toString() {
		return "\n Name of head is :"+this.nameOfHead+ "/"+ "Number of Mission is :" +this.ofMission +"Number oF Vehicle is: "+this.noVehicle;
	}
...
class Navy extends Defence{
	...
	void attact() {
		System.out.println("attact by using torpedoes..");
	}
}
class Army extends  Defence{
	...
	void display() {
		super.display();
		System.out.println("Number of Tank :"+this.noOFTank);
		System.out.println("Number of subbmirans :"+this.noofGun);
		System.out.println("Number of torpedoes :"+this.noOfBatallin);
	}
	void attact() {
		System.out.println("attact by using torpedoes..");
	}
...
class Airfores extends Defence{
	...
	void display() {
	 ...
	 void attact() {
		System.out.println("attact by using gun..");
	}
}
